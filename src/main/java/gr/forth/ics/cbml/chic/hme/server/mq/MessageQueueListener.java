...
public class MessageQueueListener implements AutoCloseable{
    ...
    static class Consumer extends DefaultConsumer {
        ...
        public Consumer(Observables publisher, Channel channel) {
            super(channel);
        ...
        public void handleDelivery(String consumerTag,
            ...
            // if the message is of known type, handle it to any
            // subscribers
            if (event.isPresent())
                this.publisher.handle(event.get())
    ...
    public boolean connect(boolean persistent) {
        try {
            ...
            Consumer consumer = new Consumer(this.publisher, channel);
